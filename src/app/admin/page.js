              ...
              <tbody>
                {data.map((entry, idx) => (
                  <tr key={idx} className="hover:bg-gray-50">
                    ...
                    <td className="px-4 py-2 border border-gray-300">{entry.client.name}<br /><span className="text-gray-500 text-xs">{entry.client.checkIn} → {entry.client.checkOut}</span></td>
