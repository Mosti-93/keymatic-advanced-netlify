      ...
      <main className="max-w-7xl mx-auto py-10 sm:px-6 lg:px-8 space-y-8">
        ...
        <div className="bg-white shadow rounded-lg p-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              className="inline-flex items-center px-4 py-2 bg-yellow-500 border border-transparent rounded-md font-semibold text-white hover:bg-yellow-600 transition"
            >
              Link Key
            </button>
          </form>
          ...
          <div className="overflow-x-auto">
            <table className="min-w-full border border-gray-300 rounded-lg">
              <thead className="bg-gray-100">
                <tr>
                  {["KEY", "ROOM NO", "MACHINE", "LOCATION", "OWNER", "EDIT"].map((col, i) => (
                    <th
                      key={i}
